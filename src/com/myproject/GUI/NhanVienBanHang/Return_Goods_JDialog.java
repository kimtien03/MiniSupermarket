...
public class Return_Goods_JDialog extends javax.swing.JDialog {
    public Return_Goods_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã hàng", "Tên hàng", "ĐVT", "Giá thu về ", "SL trả", "Tổng tiền"
            }
        ));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Return_Goods_JDialog dialog = new Return_Goods_JDialog(new javax.swing.JFrame(), true);
