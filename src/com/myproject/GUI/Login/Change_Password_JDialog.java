...
public class Change_Password_JDialog extends javax.swing.JDialog {
    public Change_Password_JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }
    
    public Change_Password_JDialog(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Change_Password_JDialog dialog = new Change_Password_JDialog(new javax.swing.JFrame(), true);
